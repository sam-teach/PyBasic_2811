...
# ГЕНЕРАТОРЫ СПИСКОВ
# пример без объяснения
import random

li = [random.randint(1, 200) for i in range(20)]
# получим список из 20 случайных чисел в диапазоне от 1 до 199

# пример рисования со звездочками
'''
            *
          * * *
        * * * * *
...
высота - 7
длинна основания - 13
1 строка - 1 звезда:1*2-1
2 строка  - 3 звезды:2*2-1
3 строка - 5 звезд:3+2
4 строка - 7 звезда:4+3
5 строка  - 9 звезды:5+4
6 строка - 11 звезд
7 строка - 13 звезд
пробелы
1 строка - 12 пробелов  : 14 - 2
2 строка  - 10 пробелов : 14 - 4
3 строка - 8 пробелов   : 14 - 6
4 строка - 6 пробелов   : 14 - 8
5 строка  - 4 пробела   : 14 - 10
6 строка - 2 пробела    : 14 - 12
7 строка - 0 пробелов   : 14 - 14
'''
strings = 4
